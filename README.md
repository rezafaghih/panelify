...
* **ModalComponent**
  هدف این کامپوننت پیاده سازی کانیتر اصلی مودال است
* **Modal**
  این کامپوننت اصلی مودال است که درون ModalComponent قرار میگیرد
* **ModalHeader**
  هدف مودال که تایتل اصلی مودال + دکمه بستن مودال به صورت خودکار در آن درج میشود
